...
var electrucalSchema = new mongoose.Schema({
    ...
    equipmentType: {
        type: Array,
        'default': [
            { name: 'UTILITY', owner: 'ampx' },
            { name: 'TRANSFORMER', owner: 'ampx' },
            { name: 'SWITCHGEAR', owner: 'ampx' },
            { name: 'MCC', owner: 'ampx' },
            { name: 'VFD', owner: 'ampx' },
            { name: 'DISTRIBUTION PANEL', owner: 'ampx' },
            { name: 'MOTOR', owner: 'ampx' },
            { name: 'MOV', owner: 'ampx' },
            { name: 'HEATER', owner: 'ampx' },
            { name: 'LIGHT', owner: 'ampx' },
            { name: 'RECEPTACLE', owner: 'ampx' },
            { name: 'UPS CHARGER', owner: 'ampx' },
            { name: 'CONTROL PANEL', owner: 'ampx' },
            { name: 'JUNCTION BOX', owner: 'ampx' }
        ]
    },
