...
var ControllersListComponent = (function () {
    ...
    ControllersListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinnerService.show();
        this.controllerService.getControllers(this.projectId).subscribe(function (controllerList) {
...
module.exports = "<div class=\"container\">\n  <div class=\"pt-2 text-center\">\n    <h1>Instrumentation List\n      <a class=\"btn btn-primary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Add new instrumentation\" (click)=\"saveInstrimentation()\">\n        <i class=\"fa fa-plus\" aria-hidden=\"true\"></i>\n      </a>\n    </h1>\n  </div>\n  <div class=\"row achievements-wrapper\">\n    <table class=\"table table-sm table-bordered table-hover table-text-style\">\n      <thead>\n        <tr>\n          <th></th>                                   <!-- 1 -->\n          <th>Item.</th>                              <!-- 2 -->\n          <th>Instrumentation Tag</th>                <!-- 3 -->\n          <th>Instrument Description</th>             <!-- 4 -->\n          <th>PID Number</th>                         <!-- 5 -->\n          <th>Service Description</th>                <!-- 6 -->\n          <th>Instrument Type 1</th>                  <!-- 7 -->\n          <th>Instrument Type 2</th>                  <!-- 8 -->\n          <th>Manufacturer</th>                       <!-- 9 -->\n          <th>Data Sheet Number</th>                  <!-- 10 -->\n          <th>PO Number</th>                          <!-- 11 -->\n          <th>Model Number</th>                       <!-- 12 -->\n          <th>Status</th>                             <!-- 13 -->\n          <th>Location</th>                           <!-- 14 -->\n          <th>System</th>                             <!-- 15 -->\n          <th>I/O Type</th>                           <!-- 16 -->\n          <th>Signal Level</th>                       <!-- 17 -->\n          <th>Power Supply</th>                       <!-- 18 -->\n          <th>Instrument Function</th>                <!-- 19 -->\n          <th>Instrument Description</th>             <!-- 20 -->\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let instrumentation of instrumentation\">\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\"><a class=\"table-cursor\"></a></td>                                                                   <!-- 1 -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.itemNumber || 'N/A'}}<a class=\"table-cursor\"></a></td>                           <!-- 2 Item -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.instrumentationTag || 'New Instrumentation'}}<a class=\"table-cursor\"></a></td>   <!-- 3 Instrumentation Tag -->                                                                              <!-- 3 Cable Conduit Tag-->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedInstrumentDescription || 'N/A'}}<a class=\"table-cursor\"></a></td>        <!-- 4 Instrument Description -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedPidNumber || 'N/A'}}<a class=\"table-cursor\"></a></td>                    <!-- 5 PID Number -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedServiceDescription || 'N/A'}}<a class=\"table-cursor\"></a></td>           <!-- 6 Service Description -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedFirstInstrumentType || 'N/A'}}<a class=\"table-cursor\"></a></td>          <!-- 7 Instrument Type 1 -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedSecondInstrumentType || 'N/A'}}<a class=\"table-cursor\"></a></td>         <!-- 8 Instrument Type 2 -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedManufacturer || 'N/A'}}<a class=\"table-cursor\"></a></td>                 <!-- 9 Manufacturer -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedDataSheetNumber || 'N/A'}}<a class=\"table-cursor\"></a></td>              <!-- 10 Data Sheet Number-->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedMrPoNumber || 'N/A'}}<a class=\"table-cursor\"></a></td>                   <!-- 11 PO Number -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedModelNumber || 'N/A'}}<a class=\"table-cursor\"></a></td>                  <!-- 12 Model Number -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedStatus || 'N/A'}}<a class=\"table-cursor\"></a></td>                       <!-- 13 Status -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedLocation || 'N/A'}}<a class=\"table-cursor\"></a></td>                     <!-- 14 Location -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedSystem || 'N/A'}}<a class=\"table-cursor\"></a></td>                       <!-- 15 System -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedIOType || 'N/A'}}<a class=\"table-cursor\"></a></td>                       <!-- 16 I/O Type -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedSignalLevel || 'N/A'}}<a class=\"table-cursor\"></a></td>                  <!-- 17 Signal Level -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedPowerSupply || 'N/A'}}<a class=\"table-cursor\"></a></td>                  <!-- 18 Power Supply -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedInstrumentFunction || 'N/A'}}<a class=\"table-cursor\"></a></td>           <!-- 19 Instrument Function -->\n          <td class=\"table-cursor\" routerLink=\"/project/{{projectId}}/instrumentations/{{instrumentation._id}}\">{{instrumentation?.selectedInstrumentDescription || 'N/A'}}<a class=\"table-cursor\"></a></td>        <!-- 20 Instrument Description -->\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</div>"
...
var InstrumentationListComponent = (function () {
    function InstrumentationListComponent(instrumentationService, router, route, spinnerService) {
        this.instrumentationService = instrumentationService;
        this.router = router;
        this.route = route;
        this.spinnerService = spinnerService;
    ...
    InstrumentationListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.spinnerService.show();
        this.instrumentationService.getInstrumentations(this.projectId).subscribe(function (instrumentationList) {
